...
\ref{sec:oned-deterministic-global-construct} we obtain the following form of
...
argument as in Section \ref{sec:oned-deterministic-global-construct} we find
that the matrix $A_{s,s}$ will have the form as shown in
...
fully deterministic and scalar so we can proceed in a similar manner to the
deterministic case.
